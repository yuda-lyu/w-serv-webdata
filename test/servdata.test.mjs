...
describe('servdata', function() {
    ...
    let res = [{ 'client': [{ 'select tabA': '[{"id":"id-tabA-peter","name":"peter","value":"peter-n[1]"},{"id":"id-tabA-rosemary","name":"rosemary","value":123.456},{"id":"id-tabA-kettle","name":"kettle","value":456}]' }, { 'select tabB': '[{"id":"id-tabB-peter","name":"peter","value":123},{"id":"id-tabB-rosemary","name":"rosemary","value":123.456}]' }, { 'call add before': '' }, { 'call add after': 3.5 }, { 'call uploadFile before': '' }, { 'call uploadFile after': { 'name': 'zdata.b1', 'size': 3 } }] }, { 'server': [{ 'saveData before': { 'cl': 'tabA', 'data': '[{"id":"id-tabA-peter","name":"peter","value":123},{"id":"id-tabA-rosemary","name":"rosemary","value":123.456},{"id":"id-tabA-kettle","name":"kettle","value":456}]' } }, { 'saveData after': { 'cl': 'tabA', 'data': '[{"n":1,"nInserted":1,"nModified":0,"ok":1},{"n":1,"nInserted":1,"nModified":0,"ok":1},{"n":1,"nInserted":1,"nModified":0,"ok":1}]' } }, { 'saveData before': { 'cl': 'tabB', 'data': '[{"id":"id-tabB-peter","name":"peter","value":123},{"id":"id-tabB-rosemary","name":"rosemary","value":123.456}]' } }, { 'saveData after': { 'cl': 'tabB', 'data': '[{"n":1,"nInserted":1,"nModified":0,"ok":1},{"n":1,"nInserted":1,"nModified":0,"ok":1}]' } }, { 'timer update tabA before': 1, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[1]' } }, { 'saveData before': { 'cl': 'tabA', 'data': '{"id":"id-tabA-peter","name":"peter","value":"peter-n[1]"}' } }, { 'saveData after': { 'cl': 'tabA', 'data': '[{"n":1,"nInserted":0,"nModified":1,"ok":1}]' } }, { 'timer update tabA after': 1, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[1]' } }, { 'kpFunExt add': { 'input': '{"pa":1,"pb":2.5}', 'output': '3.5' } }, { 'uploadFile before': { 'name': 'zdata.b1', 'size': 3 } }, { 'uploadFile after': { 'name': 'zdata.b1', 'size': 3 } }, { 'timer update tabA before': 2, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[2]' } }, { 'saveData before': { 'cl': 'tabA', 'data': '{"id":"id-tabA-peter","name":"peter","value":"peter-n[2]"}' } }, { 'saveData after': { 'cl': 'tabA', 'data': '[{"n":1,"nInserted":0,"nModified":1,"ok":1}]' } }, { 'timer update tabA after': 2, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[2]' } }, { 'timer update tabA before': 3, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[3]' } }, { 'saveData before': { 'cl': 'tabA', 'data': '{"id":"id-tabA-peter","name":"peter","value":"peter-n[3]"}' } }, { 'saveData after': { 'cl': 'tabA', 'data': '[{"n":1,"nInserted":0,"nModified":1,"ok":1}]' } }, { 'timer update tabA after': 3, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[3]' } }, { 'timer update tabA before': 4, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[4]' } }, { 'saveData before': { 'cl': 'tabA', 'data': '{"id":"id-tabA-peter","name":"peter","value":"peter-n[4]"}' } }, { 'saveData after': { 'cl': 'tabA', 'data': '[{"n":1,"nInserted":0,"nModified":1,"ok":1}]' } }, { 'timer update tabA after': 4, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[4]' } }, { 'timer update tabA before': 5, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[5]' } }, { 'saveData before': { 'cl': 'tabA', 'data': '{"id":"id-tabA-peter","name":"peter","value":"peter-n[5]"}' } }, { 'saveData after': { 'cl': 'tabA', 'data': '[{"n":1,"nInserted":0,"nModified":1,"ok":1}]' } }, { 'timer update tabA after': 5, 'r': { 'id': 'id-tabA-peter', 'name': 'peter', 'value': 'peter-n[5]' } }] }]
